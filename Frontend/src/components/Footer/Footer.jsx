    ...
    <footer className="footer">
      <Container>
        <Row>
          ...
          <div className="logo">
          <img src={logo} alt="" />
          <p>Embark on unforgettable journeys. Explore the world, one adventure at a time.</p>
          </div>
...
<div className='footer__quick-links'>
    ...
    <p className='mb-0'>email02@gmail.com</p>
      </ListGroupItem>
      <ListGroupItem className='ps-0 border-0 d-flex align-items-center gap-3'>
    <h6 className='mb-0 d-flex align-items-center gap-2'>
    ...
    <p className='mb-0'>+0123456789</p>
          ...
          <p className='copyright'>
            Copyright {year+1}, design and develop by </p>
          </Col>
        </Row>
      </Container>
    </footer>
